...
contract NarwhalTradingV2 is Initializable, ReentrancyGuardUpgradeable {
    ...
    uint256 public timeLimit; //seconds
    ...
    function executeLimitOrder(
        ...
        require(block.timestamp > orderExecutionTimeLimit[trader] + (timeLimit),"Wait a bit more");
    ...
    function openTrade(
        ...
        require(block.timestamp > orderExecutionTimeLimit[msg.sender] + (timeLimit),"Wait a bit more");
        require(
        ...
        orderExecutionTimeLimit[msg.sender] = block.timestamp;
    }
    ...
    function closeTradeMarket(
        ...
        address sender = msg.sender;
        require(block.timestamp > orderExecutionTimeLimit[sender] + (timeLimit),"Wait a bit more");
    ...
    function updateOpenLimitOrder(
        ...
        orderExecutionTimeLimit[sender] = block.timestamp;
